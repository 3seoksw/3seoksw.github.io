...
<p align="center">
    {% include figure.liquid path="../assets/img/mario/mario_1_1_showcase.gif" class="img-fluid rounded z-depth-1" zoomable=true %}
</p>
...
<a id="2" href="https://pytorch.org/tutorials/intermediate/mario_rl_tutorial.liquid">[2]</a>
Y. Feng, S. Subramanian, H. Wang, and S. Guo. "TRAIN A MARIO-PLAYING RL AGENT,"
PyTorch, accessed January 27, 2024,
https://pytorch.org/tutorials/intermediate/mario_rl_tutorial.liquid.
